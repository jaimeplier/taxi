...
urlpatterns = [
    ...
    path('tabla_administrador_ciudad/', AdministradorCiudadListarAjaxListView.as_view(), name='tab_list_administrador_ciudad'),
    path('administrador_ciudad/editar/<int:pk>', AdministradorCiudadActualizar.as_view(), name='edit_administrador_ciudad'),
